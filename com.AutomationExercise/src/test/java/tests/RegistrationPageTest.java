...
public class RegistrationPageTest extends BaseTest{
	...
	public void testRegistrationPage(String title, String password, String dob, String firstName, String lastName, 
			String address1 , String country, String state, String city, String zipCode	,  String mobileNumber) throws InterruptedException
	{
		...
		registrationPage.enterRegistrationDetails(title,password, dob, firstName, lastName, address1, 
